...
void EntityEditor::_add_component_pressed(uint32_t p_index) {
	...
	undo_redo->add_do_method(entity, SNAME("add_component"), component_name);
	undo_redo->add_do_method(this, SNAME("update_editors"));
	undo_redo->add_undo_method(entity, SNAME("remove_component"), component_name);
	undo_redo->add_undo_method(this, SNAME("update_editors"));
...
void EntityEditor::_remove_component_pressed(StringName p_component_name) {
	...
	EditorUndoRedoManager *undo_redo = EditorUndoRedoManager::get_singleton();
	undo_redo->create_action(TTR("Drop component"));
	undo_redo->add_do_method(entity, SNAME("remove_component"), p_component_name);
	undo_redo->add_do_method(this, SNAME("update_editors"));
	undo_redo->add_undo_method(entity, SNAME("add_component"), p_component_name, entity_get_component_props_data(p_component_name));
	undo_redo->add_undo_method(this, SNAME("update_editors"));
	undo_redo->commit_action();
}
...
void EntityEditor::_property_changed(const String &p_path, const Variant &p_value, const String &p_name, bool p_changing) {
    ...
    EditorUndoRedoManager *undo_redo = EditorUndoRedoManager::get_singleton();
	undo_redo->create_action(TTR("Set component value"));
	undo_redo->add_do_method(entity, SNAME("set"), p_path, p_value);
	undo_redo->add_undo_method(entity, SNAME("set"), p_path, entity->get(p_path));
	undo_redo->add_undo_method(this, SNAME("update_editors"));
	undo_redo->commit_action();
